...
MIGRATION_MODULES = {"sites": "kicoma.contrib.sites.migrations"}
...
MIDDLEWARE = [
    "kicoma.middleware.HealthCheckMiddleware",
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "kicoma.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "kicoma.users.adapters.SocialAccountAdapter"
