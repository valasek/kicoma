    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.CharField(blank=True, max_length=200, null=True, verbose_name='Poznámka')),
                ('userApproved', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='approved', to=settings.AUTH_USER_MODEL, verbose_name='Vyskladnil')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.CharField(blank=True, max_length=200, null=True, verbose_name='Poznámka')),
                ('mealGroup', models.ForeignKey(help_text='Skupina pro kterou se připravuje jídlo', on_delete=django.db.models.deletion.CASCADE, to='kitchen.MealGroup', verbose_name='Skupina strávníka')),
