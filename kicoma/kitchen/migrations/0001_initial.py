# Generated by Django 3.1 on 2020-08-08 12:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('minOnStock', models.DecimalField(decimal_places=2, default=0, help_text='Minimální množství zboží na skladu', max_digits=8, validators=[django.core.validators.MinValueValidator(Decimal('0.1'))], verbose_name='Minimálně na skladu')),
                ('totalPrice', models.DecimalField(blank=True, decimal_places=2, default=0, help_text='Celková cena zboží na skladu', max_digits=8, null=True, verbose_name='Celková cena s DPH')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('norm_amount', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(1000)], verbose_name='Počet porcí')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.CharField(blank=True, max_length=200, null=True, verbose_name='Poznámka')),
                ('userApproved', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='usrapproved', to=settings.AUTH_USER_MODEL, verbose_name='Naskladnil')),
                ('userCreated', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='usrcreated', to=settings.AUTH_USER_MODEL, verbose_name='Vytvořil')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.CharField(blank=True, max_length=200, null=True, verbose_name='Poznámka')),
                ('userApproved', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='usiapproved', to=settings.AUTH_USER_MODEL, verbose_name='Vyskladnil')),
                ('userCreated', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='usicreated', to=settings.AUTH_USER_MODEL, verbose_name='Vytvořil')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(choices=[('kg', 'kg'), ('g', 'g'), ('l', 'l'), ('ml', 'ml'), ('ks', 'ks')], max_length=2, verbose_name='Jednotka')),
                ('priceWithoutVat', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0.1'))], verbose_name='Jednotková cena bez DPH')),
                ('comment', models.CharField(blank=True, max_length=200, null=True, verbose_name='Poznámka')),
                ...
                ('vat', models.ForeignKey(blank=True, default=2, null=True, on_delete=django.db.models.deletion.CASCADE, to='kitchen.vat', verbose_name='DPH')),
            ],
            options={
                'verbose_name': 'Zboží',
                'verbose_name_plural': 'Zboží',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Datum vytvoření')),
                ('modified', models.DateTimeField(auto_now=True, verbose_name='Datum aktualizace')),
                ('amount', models.PositiveSmallIntegerField(help_text='Počet porcí', validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(1000)], verbose_name='Počet')),
                ('comment', models.CharField(blank=True, max_length=200, null=True, verbose_name='Poznámka')),
