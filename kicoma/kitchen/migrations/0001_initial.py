# Generated by Django 3.0.5 on 2020-04-04 00:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allergen', models.ManyToManyField(blank=True, to='kitchen.Allergen')),
                ('unit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kitchen.Unit')),
            ],
            options={
